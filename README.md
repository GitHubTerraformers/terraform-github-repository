...
| <a name="input_labels"></a> [labels](#input\_labels) | (Optional) The list of issue labels of the repository (key: label\_name) | `map(string)` | `null` | no |
...
| <a name="input_repository_name"></a> [repository\_name](#input\_repository\_name) | (Optional) New name for this repository (useful for renaming, but not changing the name of the resource) | `string` | `null` | no |
