...
| <a name="input_reusable_workflows"></a> [reusable\_workflows](#input\_reusable\_workflows) | (Optional) Reusable workflows enabled for organization. Default: false | `bool` | n/a | yes |
